...
ans = [0.01, 0.2, 0.3, 0.4, 0.5]
bll = [.2, .5, .8]
lf = [0.1]
egs =  [0.01, 0.2, 0.3, 0.4, 0.5]
alpha = [.2, .5, .8]
r = [1]
...
# Start simulation
run_maxLL_pr_pipline(main_dir=main_dir, subject_dir=subject_dir, param_list=param_list, overwrite=False, analysis_type='pr_random')
