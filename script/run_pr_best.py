...
# subject_dir = 'data/simulation_pr_best'
...
# Start simulation
run_maxLL_pr_pipline(main_dir=main_dir, subject_dir=subject_dir, param_list=param_list, overwrite=False, analysis_type='pr_best')
