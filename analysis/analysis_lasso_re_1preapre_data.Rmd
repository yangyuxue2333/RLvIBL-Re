...
sample_method <-  "up" # methods are: random, up, none
...
if (sample_method == "random") {
  ...
  dvs.sampling <- dvs
  # No changes made to the dataset in this condition
} else {
  print("Invalid sample_method. Please choose from: random, up, none")
}
